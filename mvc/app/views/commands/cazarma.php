...
<head>
    ...
    <link rel="stylesheet" href="css/cazarma.css">
</head>
<body>
    ...
    <div class="row nume">
       ...
       <div class="row trupe">
           <div class="col-xs-3 col-md-3 col-lg-3 Spear">
               <img alt="spear" src="images/spear.png" class="img-responsive poza_spear"></div>
           <div class="col-xs-3 col-md-3 col-lg-3 Axe">
               <img alt="Axe" src="images/axe.png" class="img-responsive poza_axe">
           </div>
           <div class="col-xs-3 col-md-3 col-lg-3 Sword">
               <img alt="Swords" src="images/sword.png" class="img-responsive poza_sword"></div>
           <div class="col-xs-3 col-md-3 col-lg-3 Archer">
               <img alt="Archer" src="images/archer.png" class="img-responsive poza_archer"></div>
       </div>

       <div class="row cost">
           <div class="col-xs-3 col-md-3 col-lg-3 ">Cost:30
               <img alt="spear" src="images/resources.png" class="img-responsive"></div>
           <div class="col-xs-3 col-md-3 col-lg-3 ">Cost:50
               <img alt="Axe" src="images/resources.png" class="img-responsive">
           </div>
           <div class="col-xs-3 col-md-3 col-lg-3 ">Cost:20
               <img alt="Swords" src="images/resources.png" class="img-responsive"></div>
           <div class="col-xs-3 col-md-3 col-lg-3 ">Cost:18
               <img alt="Archer" src="images/resources.png" class="img-responsive"></div>
       </div>
       <div class="row comanda">
           <div class="col-xs-3 col-md-3 col-lg-3 Spear_command">
               <form>
                   <div>
                       ...
                       <input type="number" class="form-control spear_form"  min="0">
                   </div>
               </form>
               </div>
           <div class="col-xs-3 col-md-3 col-lg-3 Axe_command">
               <form>
                   <div>
                       <input type="number" class="form-control axe_form"  min="0">
                   </div>
               </form>
           </div>
           <div class="col-xs-3 col-md-3 col-lg-3 Sword_command">
               <form>
                   <div>
                       <input type="number" class="form-control sword_form"  min="0">
                   </div>
               </form>
               </div>
           <div class="col-xs-3 col-md-3 col-lg-3 Archer_command">
               <form>
                   <div>
                       <input type="number" class="form-control archer_form"  min="0">
                   </div>
               </form>
               </div>
       ...
       <div class="row">
           ...
           <button type="button" class="btn btn-primary instruct">Instruct</button>
                   ...
                   <div class="modal-content">
                       ...
                       <div class="modal-body">
                           <table class="table no-border tabel-modal">
                               <tr>
                                  <th><img alt="Archer" src="images/unit_archer.png" class="img-responsive"></th>
                               ...
                               <tr>
                                   <th><img alt="Sword" src="images/unit_sword.png"></th>
    ...
    <div class="container-fluid tabel">
        ...
        <table class="table no-border">
            ...
            <tr>
                <td>Archers</td>
                <td>300</td>
                <td>03/04/2017 16:26</td>
            </tr>
            <tr>
                <td>SwordsMan</td>
                <td>125</td>
                <td>03/04/2017 18:23</td>
            </tr>
            <tr>
                <td>AxeMan</td>
                <td>244</td>
                <td>04/04/2017 10:10</td>
            </tr>
            </tbody>
        </table>
           </div>
