    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="/Proiect-TW/mvc/ranking/ranking/rankingPopulation"><span class="glyphicon glyphicon-stats"></span> Ranking </a></li>
            ...
            <div class="col-md-6 col-sm-5 col-xs-5 col-lg-6">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="text" placeholder="Enter username" required name="username">
                    </div>
                    <div class="form-group">
                        <label for="pwd">Old Password:</label>
                        <input type="password" class="form-control" id="pwd" placeholder="Enter password" required name="oldPassword">
                    </div>
                    <div class="form-group">
                        <label for="pwd2">New Password:</label>
                        <input type="password" class="form-control" id="pwd2" placeholder="Confirm Password" required name="newPassword">
                    </div>
                    <div class="checkbox">
                        <label><input type="checkbox" required> Confirm changes </label>
                    </div>
                    <?php if($data['retry']=='yes') echo '<h4><font color="red">Change password FAILED</font></h4>';?>
