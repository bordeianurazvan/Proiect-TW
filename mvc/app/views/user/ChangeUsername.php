            ...
            <div class="col-md-6 col-sm-5 col-xs-5 col-lg-6">
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="text" placeholder="Enter Username" required name="newUsername">
                    </div>
                    <div class="checkbox">
                        <label><input type="checkbox" required> Confirm changes </label>
                    </div>
                    <?php if($data['retry']=='yes') echo '<h4><font color="red">Change username FAILED</font></h4>';?>
