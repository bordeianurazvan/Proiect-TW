...
<head>
    ...
    <link rel="stylesheet" href="/Proiect-TW/mvc/public/css/Iron.css">
</head>
<body>
...
<div class="center">
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 img-responsive name"><img  alt="Iron" src="/Proiect-TW/mvc/public/images/iron3.png">Iron mine (Level <?php echo $data['ironLevel']; ?>)</div>
    </div>
    <div class="row description">
        <div>In the iron mine your workers dig the war-crucial iron. The higher its level the more iron is produced.</div>
    </div>
    <div>
        <div class="Table1">
            <table class="table no-border">
                ...
                <tr>
                    ...
                    <th>Production at level <?php echo ($data['ironLevel']+1); ?></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td><?php echo (100*$data['ironLevel']); ?></td>
                    <td><?php echo (100*($data['ironLevel']+1)); ?></td>
                </tr>
                </tbody>
            </table>
        </div>
