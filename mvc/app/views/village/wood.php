...
<div class="center">
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 img-responsive name"><img  alt="Wood" src="/Proiect-TW/mvc/public/images/wood3.png">Timber camp (Level <?php echo $data['woodLevel']; ?>)</div>
    </div>
        ...
        <div class="Table1">
            <table class="table no-border">
                ...
                <tr>
                    ...
                    <th>Production at level <?php echo ($data['woodLevel']+1); ?></th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td><?php echo (100*$data['woodLevel']); ?></td>
                    <td><?php echo (100*($data['woodLevel']+1)); ?></td>
                </tr>
                </tbody>
            </table>
        </div>
