...
<div class="col-md-8 col-xs-10 col-lg-8 col-sm-10 center">
        ...
        <div class="col-md-8 col-xs-12 col-sm-10 col-lg-10">
            <div id="image_map">
                <map id="map_id" name="map_example">
                    <area href="Construct.html" alt="Main-Building" target="_blank" shape=poly coords="420,100,540,100,540,210,420,210">
                    <area href="Storage.html" alt="Storage" target="_blank" shape=poly coords="160,170,270,170,270,280,160,280">
                    <area href="cazarma.html" alt="Barracks" target="_blank" shape=poly coords="540,290,660,290,660,410,540,410">
                    <area href="Wood.html" alt="Wood" target="_blank" shape=poly coords="650,450,770,450,770,570,650,570">
                    <area href="Stone.html" alt="Stone" target="_blank" shape=poly coords="5,400,120,400,120,500,5,500">
                    <area href="Iron.html" alt="Iron" target="_blank" shape=poly coords="1,1,120,1,120,100,1,100">
                </map>
    ...
    <div class="row">
        <div class="butoane">
            <br>
            <a href="Construct.html" class="btn btn-primary butonel" role="button">Main Building</a>
            <a href="cazarma.html" class="btn btn-primary " role="button">Baracks</a>
            <a href="Storage.html" class="btn btn-primary " role="button">Storage</a>
            <a href="Wood.html" class="btn btn-primary " role="button">Wood</a>
            <a href="Stone.html" class="btn btn-primary " role="button">Stone</a>
            <a href="Iron.html" class="btn btn-primary " role="button">Iron</a>
            <a href="movements.html" class="btn btn-primary " role="button">Movements</a>
            <a href="PrivireDeAnsamblu.html" class="btn btn-primary " role="button">Villages</a>
        </div>
    </div>
</div>
<div class="col-md-2 col-xs-1 col-lg-2 col-sm-1">
